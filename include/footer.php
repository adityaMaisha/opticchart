...
<footer class="footer-section padding-top-1">
         ...
         <div class="container">
            ...
            <div class="row align-items-center ">
               ...
               <div class="col-lg-4 order-lg-1 order-md-3 order-sm-3 order-3 wow fadeIn" data-wow-delay="300ms">
                  ...
                  <p class="paragraph-13 footer-copyright-text font-weight-500 fontface-two text-color-dark padding-top-10">&copy; Copyright Optic Chart. All Rights Reserved.
                  ...
                  <div class="footer-links padding-top-5">
                     ...
                     <ul class="footer-links-outer text-center">
                        ...
                        <li class="footer-links-inner">
                           ...
                           <a class="scroll" href="#account">Account</a>
               ...
               <div class="col-lg-2 order-lg-1 clearfix order-md-1 order-sm-1 order-1 wow fadeIn" data-wow-delay="400ms">
                  ...
                  <a href="#." class="footer-logo"><img src="images/logo.png" alt="logo-treely"></a>
